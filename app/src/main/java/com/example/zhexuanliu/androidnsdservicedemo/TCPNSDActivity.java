...
public class TCPNSDActivity extends AppCompatActivity
{
    /**
    ...
    /**
     * Mapping between NSD Service name and NSDServer
     */
    private HashMap<String, NSDServer> mNSDServerMap;

    /**
     * Mapping between NSD Service name and NSDClient
     */
    private HashMap<String, NSDClient> mNSDClientMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tcpnsd);
        ...
        this.mNSDServerMap = new HashMap<String, NSDServer>();
        this.mNSDClientMap = new HashMap<String, NSDClient>();
    ...
    private void initThreads(){
        ...
        mBackgroundHandler = new Handler(mBackgroundThread.getLooper()){
            ...
            private void sendMessage()
            {
                ...
                // if its host, then it should call sendMessage method in NSDServer
                if (isHost)
                {
                    NSDServer server = mNSDServerMap.get(serviceName);
                    server.sendMessage(messageToSend);
                }

                if (connected)
                {
                    NSDClient client = mNSDClientMap.get(serviceName);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case Constants.MSG_CONNECTED_SERVICE:
                        NSDClient client = (NSDClient) msg.obj;
                    ...
                    case Constants.MSG_SERVER_CREATED:
                        NSDServer server = (NSDServer) msg.obj;
    ...
    public void onConnectClick(View view)
    {
        ...
        NSDClient client = new NSDClient(host, port, mMainThreadHandler, serviceName);
    }
    ...
    public void onRegisterClick(View view)
    {
        ...
        NSDServer server = new NSDServer(serviceName, mMainThreadHandler);
    }
